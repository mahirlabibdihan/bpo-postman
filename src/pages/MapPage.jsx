  ...
  return <div className="field-app">
    ...
    <main className="map-layout minimal-map-layout">
      <section className="map-stage">
        ...
        <button className="follow-location minimal-follow-location" aria-label="চিহ্নিত অবস্থানে যান" onClick={() => setFollowRequest((value) => value + 1)} disabled={!position}><LocateFixed size={23} /></button>
